...
| Domain-specific social/comment extractors | Reference includes specialized extractors for Reddit, Hacker News, X/Twitter, Mastodon, YouTube, and others. | Partially implemented | GitHub discussion preservation is covered by `github-pull-request`; Hacker News listing extraction is covered by `domain--hacker-news-listing.html`; Reddit post/comment extraction is covered by `reddit-discussion`. Other social/comment domains remain fixture-led follow-up work. |
